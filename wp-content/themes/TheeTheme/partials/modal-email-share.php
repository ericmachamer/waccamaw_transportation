...
<div class="modal">
  ...
  <form class="form form-email-share row" action="#" method="POST" role="form"
        data-nonce="<?php echo wp_create_nonce('submit-email-share'); ?>">
    ...
    <div class="form-field col-xs-12">
      ...
      <input id="subject" name="subject" class="form-control" type="text" required="true"
