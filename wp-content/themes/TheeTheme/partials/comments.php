...
<?php if (have_comments()) : ?>
  ...
  <ul class="comments-list">
      <?php wp_list_comments(array('callback' => 'thee_comment_list')); ?>
  </ul>
<?php endif; ?>
          ...
          <ul>
              ...
              <?php else : ?>
                ...
                <li>
                  ...
                  <input type="text" name="author" id="author" class="medium" value="<?php echo $comment_author; ?>"
                ...
                <li>
                  ...
                  <input type="text" name="email" id="email" class="medium" value="<?php echo $comment_author_email; ?>"
                         size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
                </li>
                <li>
                  <label for="url">URL:</label>
                  <input type="text" name="url" id="url" class="medium" value="<?php echo $comment_author_url; ?>"
                         size="22" tabindex="3"/>
                </li>
