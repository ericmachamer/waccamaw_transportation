 ...
 */
function thee_submit_email_share_form()
{
...
add_action('wp_ajax_nopriv_thee_submit_email_share_form', 'thee_submit_email_share_form');
add_action('wp_ajax_thee_submit_email_share_form', 'thee_submit_email_share_form');