 ...
 * Load custom widgets
 */
function thee_load_widgets()
{
    // register_widget('thee_custom_widget');
}

add_action('widgets_init', 'thee_load_widgets');

/**
 * Custom Widget Template
 */
class thee_custom_widget extends WP_Widget
{
    ...
    function form($instance)
    {
      ...
      <p>
        ...
        <input id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>"
               value="<?php echo $instance['title']; ?>" class="widefat" type="text"></input>
      </p>
        <?php
    }
}